...
void posicionaBarco(int mat[10][10], int barco)
{
    ...
    if(barco == 1)
    {
            ...
            while(validaEntradaLinhaColuna(linha, coluna) != 1 || validaPosicao(mat, barco, (linha -1), (coluna - 65), 'H') != 1)
            {
    ...
    else
    {
            ...
            while(validaEntradaLinhaColuna(linha, coluna) == 0 || validaPosicao(mat, barco, (linha -1), (coluna - 65), orientacao) == 0)
            {
                printf("Posicao indisponivel!\n");
                scanf("%d %c %c", &linha, &coluna, &orientacao);
            }
...
void printaPosicionamento(int jogador, int barco, int nm)
{
    if(jogador == 1)
    {
        ...
        char msg12[60] = "Jogador 1 - Posicione o barco de tamanho 3 (2/2)";
            ...
            if(barco == 1)
            {
                if(nm == 1)imprimeMensagem(msg1);
                if(nm == 2)imprimeMensagem(msg2);
                if(nm == 3)imprimeMensagem(msg3);
                if(nm == 4)imprimeMensagem(msg4);
                if(nm == 5)imprimeMensagem(msg5);
                if(nm == 6)imprimeMensagem(msg6);
            }
            if(barco == 2)
            {
                if(nm == 1)imprimeMensagem(msg7);
                if(nm == 2)imprimeMensagem(msg8);
                if(nm == 3)imprimeMensagem(msg9);
                if(nm == 4)imprimeMensagem(msg10);
            }
            if(barco == 3)
            {
                if(nm == 1)imprimeMensagem(msg11);
                if(nm == 2)imprimeMensagem(msg12);
            }
    }
    ...
    while(jogadas <= 40)
    {
        if(jogadas % 2 != 0)
        {
            ...
            scanf("%d %c", &linha, &coluna);
                ...
                while(validaEntradaLinhaColuna(linha, coluna) != 1 || podeAtirar(jogador2, linha - 1, coluna - 65) != 1)
                {
                    linha = 0;
                    coluna = 'a';
                    printf("Posicao indisponivel!\n");
        ...
        if(jogadas % 2 == 0)
        {
            ...
            scanf("%d %c", &linha, &coluna);
                ...
                while(validaEntradaLinhaColuna(linha, coluna) != 1 || podeAtirar(jogador1, linha - 1, coluna - 65) != 1)
                {
                    printf("Posicao indisponivel!\n");
                    scanf("%d %c", &linha, &coluna);
                }
